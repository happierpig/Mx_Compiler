...
test_cases_dir = './testcases/codegen/sorting/'
...
def javac():
    ...
    ret, val = subprocess.getstatusoutput('find ./src -name "*.java" -print0|xargs -0 javac -d runContain -cp antlr-4.9.2-complete.jar')
    printRet(ret, val)
    return ret
